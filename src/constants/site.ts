export const siteConfig = {
  ...
  social: {
    ...
    linkedin: "https://linkedin.com/in/cristian-dan",
    github: "https://github.com/cristiandan",
  },
};
...
**What I do now:** Fractional CTO, technical co-founder, or hands-on engineering — whatever gets your product shipped.`,
  ...
  principles: [
    { title: "Ship, then iterate", description: "Perfect is the enemy of shipped" },
    { title: "Own the outcome", description: "Not just the code" },
    { title: "Security by default", description: "Not as an afterthought" },
    { title: "Clear > clever", description: "Maintainability wins" },
  ],
};
